...
(async () => {
    const DIR = {
        email: 'smcke386@eq.edu.au',  // replace YOUR EMAIL with your email for auto login (keep everything else the same)
        password: 'TeddyAndAz1290.@',  // replace YOUR PASSWORD with your password for auto login
